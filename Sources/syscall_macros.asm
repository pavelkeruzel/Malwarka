...
%1:                          ; Define the label with the name provided as the first argument
    ...
    lea rcx, [rel %1_syscall] ; Load the effective address of the unique syscall instruction into rcx
    jmp rcx                  ; Jump to the address stored in rcx, effectively jumping to the syscall instruction
    ret                      ; Return from the procedure

%1_syscall:                  ; Define a unique label for the actual syscall instruction
